...
namespace LAB_AV2_2025_1
{
    public class PlaneDrawer
    {
        ...
        private void CreateVertices()
        {
            ...
            verts[0] = new VertexPositionColor(new Vector3(10, -1, -10), Color.Blue);
            verts[1] = new VertexPositionColor(new Vector3(10, -1, 10), Color.Blue);
            verts[2] = new VertexPositionColor(new Vector3(-10, -1, 10), Color.Blue);

            verts[3] = new VertexPositionColor(new Vector3(-10, -1, -10), Color.Blue);
            verts[4] = new VertexPositionColor(new Vector3(10, -1, -10), Color.Blue);
            verts[5] = new VertexPositionColor(new Vector3(-10, -1, 10), Color.Blue);
        }
